...
![сьютов](https://img.shields.io/badge/сьютов-55-2f9e44)
...
npm run test:all   # добавляет 46 браузерных сьютов — шесть-восемь минут
```

Всего **55 сьютов**. Узловая половина идёт на каждый push и каждый pull request; в неё
