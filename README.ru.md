...
![сьютов](https://img.shields.io/badge/сьютов-56-2f9e44)
...
npm run test:all   # добавляет 47 браузерных сьютов — шесть-восемь минут
```

Всего **56 сьютов**. Узловая половина идёт на каждый push и каждый pull request; в неё
