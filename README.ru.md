...
![версия](https://img.shields.io/badge/version-2.5.5-3b5bdb)
![Chrome MV3](https://img.shields.io/badge/Chrome-MV3-4c6ef5)
![сьютов](https://img.shields.io/badge/сьютов-40-2f9e44)
...
npm run test:all   # добавляет 32 браузерных сьюта — шесть-восемь минут
```

Всего **40 сьютов**. Узловая половина идёт на каждый push и каждый pull request; в неё
